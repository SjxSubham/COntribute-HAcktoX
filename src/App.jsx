...
import image1 from "./assets/Alex.jpeg";
import image2 from "./assets/Naina.jpeg";
import image3 from "./assets/John.jpeg";
import image4 from "./assets/Lina.jpeg";
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center">
            <h2 className="text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
              Hacktoberfest 2025
            </h2>
            <p
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1" data-aos="fade-right">
            ...
            >
              ...
              much more than keep the project alive.
            </p>
