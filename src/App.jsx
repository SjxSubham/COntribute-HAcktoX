...
function App() {
	...
	const fetchWithCache = async (
		...
		try {
			...
			if (cachedData) {
				console.log(
					`Using expired cache for ${cacheKey} due to API error`
				);
		...
		<div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-900 text-white">
			...
			<section id="home" className="relative pt-32 pb-24 overflow-hidden">
				...
				<div className="container mx-auto px-6 relative z-10">
					<div className="text-center">
						...
						>
							Join the global celebration of open source.
							Contribute, learn, and earn digital rewards in this
							month-long event.
						</p>
						<div
			...
			<section className="container mx-auto px-6 py-24">
				...
				>
					...
					<div className="relative mb-8">
						...
						<div className="relative bg-black/30 border border-white/10 rounded-xl py-8 px-4">
							<div className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-400 flex justify-center items-baseline">
								...
								<span className="text-sm text-indigo-300 ml-2 font-normal">
									visitors
								</span>
							</div>
					...
					<div className="bg-white/5 backdrop-blur-md rounded-lg p-4  text-sm">
						<p>
							Join our growing community of open source
							enthusiasts!
						</p>
			...
			>
				...
				<p
					...
					data-aos-delay="200"
				>
					Our platform is built with cutting-edge technologies to
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
					...
					>
						...
						<p className="">
							...
							experience with instant hot module replacement
						</p>
					</div>
					...
					>
						...
						<p className="">
							Styled with Tailwind CSS for beautiful, responsive
							design that adapts to any device or screen size
						</p>
					</div>
					...
					>
						...
						<p className="">
							...
							with reusable components and efficient state
							management
						</p>
					</div>
				</div>
				...
				<div className="grid md:grid-cols-2 gap-12 items-center">
					<div className="order-2 md:order-1" data-aos="fade-right">
						...
						<p
							...
							data-aos-delay="200"
						>
							Hacktoberfest is DigitalOcean's annual event that
							encourages people to contribute to open source
							throughout October. Much of modern tech
							infrastructure—including some of DigitalOcean's own
							products—relies on open-source projects built and
							maintained by passionate people who often don't have
							the staff or budgets to do much more than keep the
							project alive.
						</p>
						...
						<p
							...
							data-aos-delay="400"
						>
							Hacktoberfest is all about giving back to those
							projects, sharpening skills, and celebrating all
							things open source, especially the people who make
							open source so special.
						</p>
						...
						>
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-bold rounded-xl hover:bg-white/20 transition-all flex items-center"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
					...
					{[
						...
						>
							...
							<div className="relative">
								<p className="text-3xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-cyan-500">
									{member.name}
								</p>
				...
				>
					{contributorsLoading ? (
						...
						<div className="py-10">
							...
							<p className=" mt-4">
								GitHub API rate limits may have been reached.
								You can still view all contributors directly on{" "}
								<a
				...
				>
					{stargazersLoading ? (
						...
						<div className="py-10">
							...
							<p className=" mt-4">
								GitHub API rate limits may have been reached.
								You can still view all stargazers directly on{" "}
								<a
									href="https://github.com/SjxSubham/COntribute-HAcktoX/stargazers"
									target="_blank"
									rel="noopener noreferrer"
			...
			>
				<div className="text-center mb-16" data-aos="fade-down">
					...
					<p className=" max-w-2xl mx-auto">
						Hear from developers who participated in previous
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					<div
						className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 relative group hover:border-pink-500/50 transition-all"
						data-aos="fade-up"
						data-aos-delay="100"
					>
						...
						<div className=" mb-6 italic">
							"Hacktoberfest was my gateway into open source. I
							went from being intimidated by GitHub to submitting
							multiple PRs. The community was incredibly welcoming
							and helpful!"
						</div>
					...
					<div
						className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 relative group hover:border-purple-500/50 transition-all"
						data-aos="fade-up"
						data-aos-delay="200"
					>
						...
						<div className=" mb-6 italic">
							"Participating in Hacktoberfest helped me land my
							first developer job. The skills I gained by
							contributing to real projects were exactly what
					...
					<div
						className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 relative group hover:border-indigo-500/50 transition-all"
						data-aos="fade-up"
						data-aos-delay="300"
					>
						...
						<div className=" mb-6 italic">
							"As a project maintainer, Hacktoberfest brought in
							valuable contributions we wouldn't have received
							otherwise. Some contributors even became regular
							team members!"
						</div>
						<div className="flex items-center">
				...
				<div className="flex justify-center mt-10">
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-6 py-3 rounded-lg hover:shadow-lg hover:shadow-purple-500/40 transition-all"
					>
						Share Your Story
					</a>
				</div>
				...
				<div className="bg-gradient-to-r from-pink-500/20 to-purple-600/20 backdrop-blur-md p-12 rounded-3xl border border-white/10 text-center relative overflow-hidden">
					...
					<div className="relative z-10">
						...
						<p className=" mb-8 max-w-2xl mx-auto text-lg">
							Join thousands of developers around the world in
							supporting open source during Hacktoberfest. Your
						...
						<div className="flex flex-wrap justify-center gap-4">
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-pink-500/50 transition-all transform hover:-translate-y-1 flex items-center"
							>
								<svg
									className="h-5 w-5 mr-2"
									fill="currentColor"
