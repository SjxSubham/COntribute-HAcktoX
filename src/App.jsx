...
function App() {
  ...
  // Add this useEffect for legacy browser support
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-900 text-white">
      ...
      >
        <nav className="container mx-auto px-6 py-4" aria-label="Main navigation">
          <div className="flex items-center justify-between">
            ...
            <div className="space-x-6" role="navigation" aria-label="Primary">
              <a
                href="#home"
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center">
            ...
            <p className="text-2xl text-indigo-200 mb-10 max-w-3xl mx-auto">
              Join the global celebration of open source. Contribute, learn, and earn digital rewards in this month-long event.
            </p>
      ...
      <main id="main-content" tabIndex="-1">
        ...
        >
          <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-10 max-w-md mx-auto text-center shadow-xl hover:shadow-pink-500/20 transition-all duration-300">
            ...
            <h2 id="visitor-counter-title" className="text-2xl font-bold text-white mb-4 mt-6">Site Visitors</h2>
            ...
            <div className="relative mb-8">
              ...
              <div className="relative bg-black/30 border border-white/10 rounded-xl py-8 px-4">
                <div className="text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-orange-400 flex justify-center items-baseline">
                  ...
                  <span className="text-sm text-indigo-300 ml-2 font-normal" aria-hidden="true">visitors</span>
                </div>
                <div className="absolute top-0 right-0 mt-2 mr-2 bg-gradient-to-r from-green-400 to-green-600 text-xs text-white px-2 py-1 rounded-full flex items-center">
                  <span className="w-2 h-2 bg-white rounded-full mr-1 animate-ping absolute inline-flex" aria-hidden="true"></span>
                  <span className="w-2 h-2 bg-white rounded-full mr-1 relative inline-flex" aria-hidden="true"></span>
                  Live
                </div>
              </div>
            </div>
        ...
        >
          <h2 id="features-title" className="text-4xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
            Amazing Features
          </h2>
          <p className="text-center text-indigo-200 mb-16 max-w-2xl mx-auto">
            Our platform is built with cutting-edge technologies to provide you with the best experience possible.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:border-pink-500/50 transition-all group hover:transform hover:-translate-y-2 duration-300">
            ...
            <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:border-purple-500/50 transition-all group hover:transform hover:-translate-y-2 duration-300">
            ...
            <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 hover:border-indigo-500/50 transition-all group hover:transform hover:-translate-y-2 duration-300">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-purple-800/30 to-pink-800/30 rounded-3xl blur-3xl opacity-30 -z-10" aria-hidden="true"></div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 id="about-title" className="text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
                About Hacktoberfest
              </h2>
            ...
            <div className="relative order-1 md:order-2">
              ...
              <div className="relative bg-black rounded-lg overflow-hidden border border-white/10">
                <div className="aspect-w-16 aspect-h-9 bg-gradient-to-br from-indigo-900 to-purple-900 p-6 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 180 180" className="mx-auto" aria-hidden="true">
        ...
        >
          <h2 id="teams-title" className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
            Our Team
          </h2>
        ...
        >
          ...
          {repoStats.loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center group hover:border-pink-500/50 hover:transform hover:-translate-y-2 transition-all duration-300" role="group">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 left-1/2 w-12 h-1 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full transform -translate-x-1/2" aria-hidden="true"></div>
                </div>
              </article>

              <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center group hover:border-purple-500/50 hover:transform hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 left-1/2 w-12 h-1 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full transform -translate-x-1/2" aria-hidden="true"></div>
                </div>
              </article>

              <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center group hover:border-indigo-500/50 hover:transform hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 left-1/2 w-12 h-1 bg-gradient-to-r from-indigo-500 to-blue-500 rounded-full transform -translate-x-1/2" aria-hidden="true"></div>
                </div>
              </article>

              <article className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center group hover:border-blue-500/50 hover:transform hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 left-1/2 w-12 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full transform -translate-x-1/2" aria-hidden="true"></div>
                </div>
              </article>
            </div>
          )}
        ...
        >
          <div className="text-center mb-16">
            <h2 id="contributors-title" className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
              Our Contributors
            </h2>
            <p className="text-indigo-200 max-w-2xl mx-auto">
          ...
          <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {contributorsLoading ? (
              ...
              <>
                <div role="status" aria-live="polite" className="mb-6 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500">
                  {contributors.length}
                </div>
                <h3 className="text-2xl text-white mb-10">Contributors and counting!</h3>
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <div className="relative mb-3 group-hover:transform group-hover:-translate-y-1 transition-all duration-300">
                          <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity" aria-hidden="true"></div>
                          <img
        ...
        >
          <div className="text-center mb-16">
            <h2 id="stargazers-title" className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">
              Our Stargazers
            </h2>
            <p className="text-indigo-200 max-w-2xl mx-auto">
          ...
          <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 text-center">
            {stargazersLoading ? (
              ...
              <>
                <div role="status" aria-live="polite" className="mb-6 text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-amber-500">
                  {stargazers.length}
                </div>
                <h3 className="text-2xl text-white mb-10">Amazing Stargazers!</h3>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                  {stargazers.map((stargazer) => (
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <div className="relative mb-3 group-hover:transform group-hover:-translate-y-1 transition-all duration-300">
                          <div className="absolute -inset-0.5 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-full blur opacity-0 group-hover:opacity-100 transition-opacity" aria-hidden="true"></div>
                          <img
                          ...
                          />
                          <div className="absolute -top-1 -right-1 bg-gradient-to-r from-yellow-400 to-amber-500 w-6 h-6 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity" aria-hidden="true">
        ...
        >
          <div className="bg-gradient-to-r from-pink-500/20 to-purple-600/20 backdrop-blur-md p-12 rounded-3xl border border-white/10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 id="cta-title" className="text-4xl font-bold mb-4 text-white">Ready to Start Contributing?</h2>
      ...
      {/* Footer */}
      <footer
        className="bg-black/50 backdrop-blur-lg text-white py-16 mt-12 border-t border-white/10"
        role="contentinfo"
      >
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded"
            ...
            <div>
              ...
              <ul className="space-y-2 text-indigo-200">
                <li><a href="https://hacktoberfest.com/participation/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Getting Started</a></li>
                <li><a href="https://hacktoberfest.com/resources/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Documentation</a></li>
                <li><a href="https://hacktoberfest.com/faq/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">FAQs</a></li>
                <li><a href="https://hacktoberfest.com/community/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Community</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-indigo-200">
                <li><a href="https://github.com/topics/hacktoberfest" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Find Projects</a></li>
                <li><a href="https://hacktoberfest.com/profile/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Register Event</a></li>
                <li><a href="https://hacktoberfest.com/participation/#rules" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Event Rules</a></li>
                <li><a href="https://hacktoberfest.com/participation/#pr-mr-details" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Submit PR</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-indigo-200">
                <li><a href="https://hacktoberfest.com/contact/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Support</a></li>
                <li><a href="https://hacktoberfest.com/about/#sponsors" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Sponsors</a></li>
                <li><a href="https://hacktoberfest.com/about/#partners" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Partners</a></li>
                <li><a href="https://hacktoberfest.com/brand-guidelines/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Press Kit</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-white/10 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm text-indigo-300">
              <a href="https://hacktoberfest.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-purple-900 rounded px-1">Privacy Policy</a>
              <a href="https://hacktoberfest.com/terms-of-service/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-purple-900 rounded px-1">Terms of Service</a>
              <a href="https://hacktoberfest.com/participation/#values" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400 transition-colors focus:outline-none focus:ring-2 focus:ring-pink-500 rounded px-1">Code of Conduct</a>
            </div>
          </div>
        </div>
      </footer>
